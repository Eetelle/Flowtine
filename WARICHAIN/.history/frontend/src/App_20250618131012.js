...
function App() {
    ...
    const fetchCities = async () => {
      try {
        const res = await fetch(
          `https://wft-geo-db.p.rapidapi.com/v1/geo/countries/${selectedCountryCode(selectedCountry)}/cities?limit=10&sort=-population`,
          {
            method: "GET",
            headers: {
  ...
  const selectedCountryCode = (countryName) => {
    const map = {
      Benin: "BJ",
      Togo: "TG",
      "Burkina Faso": "BF",
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <select className="form-select mb-3" value={selectedCountry} onChange={(e) => setSelectedCountry(e.target.value)}>
